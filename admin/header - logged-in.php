<header>
    <div id="logo-pic">
        <a href="default.php"> <img src="images/logo-removebg-preview.png" alt="saiftech" id="logo"
    ...
    <nav class="main-menu active11">
        <div id="menu-items1">
            ...
            <div id="account">
                <a href="profile page.php" class="links">
                    <b>account</b>
                </a>
            </div>
            ...
            <div class="item-hf">
                <a href="products page.php" class="links">
                    <b>add products</b>
                </a>
            </div>
        </div>
